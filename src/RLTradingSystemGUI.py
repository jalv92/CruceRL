    ...
    class TrainingConfigDialog(tk.Toplevel):
        ...
        def setup_algo_tab(self, frame):
            ...
            for algo in ['PPO', 'A2C', 'DQN']:
                rb = tk.Radiobutton(
                    algo_frame, text=algo, variable=self.config_panel.algo_var, value=algo,
            ...
            timesteps_entry = tk.Entry(frame, textvariable=self.config_panel.timesteps_var, width=10, **entry_style)
            ...
            lr_entry = tk.Entry(frame, textvariable=self.config_panel.learning_rate_var, width=10, **entry_style)
            ...
            batch_entry = tk.Entry(frame, textvariable=self.config_panel.batch_size_var, width=10, **entry_style)
            ...
            n_steps_entry = tk.Entry(frame, textvariable=self.config_panel.n_steps_var, width=10, **entry_style)
            ...
            for device in ['auto', 'cpu', 'cuda']:
                rb = tk.Radiobutton(
                    device_frame, text=device, variable=self.config_panel.device_var, value=device,
                    bg=COLORS['bg_dark'], fg=COLORS['fg_light'],
                    selectcolor=COLORS['bg_medium'], 
                    activebackground=COLORS['bg_dark'],
                    activeforeground=COLORS['accent']
        ...
        def setup_env_tab(self, frame):
            ...
            balance_entry = tk.Entry(frame, textvariable=self.config_panel.balance_var, width=10, **entry_style)
            ...
            window_entry = tk.Entry(frame, textvariable=self.config_panel.window_size_var, width=10, **entry_style)
            ...
            commission_entry = tk.Entry(frame, textvariable=self.config_panel.commission_var, width=10, **entry_style)
            ...
            position_entry = tk.Entry(frame, textvariable=self.config_panel.position_size_var, width=10, **entry_style)
            ...
            slippage_entry = tk.Entry(frame, textvariable=self.config_panel.slippage_var, width=10, **entry_style)
            ...
            stop_entry = tk.Entry(frame, textvariable=self.config_panel.stop_loss_var, width=10, **entry_style)
            ...
            profit_entry = tk.Entry(frame, textvariable=self.config_panel.take_profit_var, width=10, **entry_style)
        ...
        def setup_reward_tab(self, frame):
            ...
            reward_scaling_entry = tk.Entry(frame, textvariable=self.config_panel.reward_scaling_var, width=10, **entry_style)
            ...
            inactivity_entry = tk.Entry(frame, textvariable=self.config_panel.inactivity_penalty_var, width=10, **entry_style)
            ...
            bankruptcy_entry = tk.Entry(frame, textvariable=self.config_panel.bankruptcy_penalty_var, width=10, **entry_style)
            ...
            drawdown_entry = tk.Entry(frame, textvariable=self.config_panel.drawdown_factor_var, width=10, **entry_style)
            ...
            win_rate_entry = tk.Entry(frame, textvariable=self.config_panel.win_rate_bonus_var, width=10, **entry_style)
            ...
            capital_entry = tk.Entry(frame, textvariable=self.config_panel.capital_efficiency_bonus_var, width=10, **entry_style)
            ...
            time_decay_entry = tk.Entry(frame, textvariable=self.config_panel.time_decay_factor_var, width=10, **entry_style)
            ...
            normalize_check = tk.Checkbutton(
                ...
                variable=self.config_panel.normalize_rewards_var,
                bg=COLORS['bg_dark'],
                fg=COLORS['fg_light'],
                selectcolor=COLORS['bg_medium'],
                activebackground=COLORS['bg_dark'],
        ...
        def setup_presets_tab(self, frame):
            ...
            hft_button = tk.Button(
                ...
                command=lambda: self.config_panel.apply_preset("hft"),
                bg=COLORS['bg_medium'],
                fg=COLORS['fg_white'],
                activebackground=COLORS['bg_light'],
                activeforeground=COLORS['fg_white'],
            ...
            position_button = tk.Button(
                ...
                command=lambda: self.config_panel.apply_preset("position"),
                bg=COLORS['bg_medium'],
                fg=COLORS['fg_white'],
                activebackground=COLORS['bg_light'],
                activeforeground=COLORS['fg_white'],
            ...
            trend_button = tk.Button(
                ...
                command=lambda: self.config_panel.apply_preset("trend"),
                bg=COLORS['bg_medium'],
                fg=COLORS['fg_white'],
                activebackground=COLORS['bg_light'],
                activeforeground=COLORS['fg_white'],
            ...
            self.config_panel.preset_description = description_text
...
- Mayor factor de escalado de recompensa"""
            ...
            # Trading de Posición
            self.reward_scaling_var.set("0.01")
            self.inactivity_penalty_var.set("-0.00005")
            self.drawdown_factor_var.set("0.2")
            self.win_rate_bonus_var.set("0.005")
            self.normalize_rewards_var.set(True)
            self.position_size_var.set("0.2")   # Posiciones más grandes
            self.stop_loss_var.set("0.03")      # Stop loss más amplio
            self.take_profit_var.set("0.06")     # Take profit más amplio
            
            description = """Trading de Posición

Configuración optimizada para estrategias de trading que mantienen posiciones durante períodos más largos, buscando movimientos significativos del mercado.

Características principales:
- Penalización mínima por inactividad para permitir paciencia
- Mayor énfasis en el control de drawdown
- Bonificación por mantener un alto win rate
- Posiciones más grandes para maximizar las ganancias
- Stops y targets más amplios"""
            
        elif preset_type == "trend":
            # Trading de Tendencia
            self.reward_scaling_var.set("0.02")
            self.inactivity_penalty_var.set("-0.0001")
            self.normalize_rewards_var.set(True)
            self.position_size_var.set("0.15")   # Posiciones moderadas
            self.stop_loss_var.set("0.03")       # Stop loss moderado
            self.take_profit_var.set("0.09")      # Take profit amplio (ratio 1:3)
            self.bankruptcy_penalty_var.set("-2.0")  # Mayor penalización por quiebra
            
            description = """Trading de Tendencia

Configuración optimizada para estrategias que buscan capturar tendencias de mercado consistentes, permitiendo que las ganancias corran mientras se controla el riesgo.

Características principales:
- Equilibrio entre actividad y paciencia
- Énfasis en dejar correr las ganancias (ratio riesgo/recompensa 1:3)
- Normalización de recompensas para estabilidad a largo plazo
- Posiciones de tamaño moderado
- Mayor penalización por quiebra para preservar capital"""
